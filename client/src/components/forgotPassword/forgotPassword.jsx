...
import { forgotPassword, updatePassword } from "../../api/user.js"; // Import backend API functions
...
const ForgotPassword = () => {
  ...
  const [step, setStep] = useState(1); // To handle step in the process (1: Email, 2: OTP, 3: Update Password)
  ...
  const handleVerifyOTP = (e) => {
    ...
    if (otp === generatedOtp) {
      setSuccessMessage("OTP verified! You can now update your password.");
  ...
  const handleUpdatePassword = async (e) => {
    ...
    try {
      ...
      setSuccessMessage("Password successfully update. You can now log in.");
      navigate("/signIn"); // Redirect to sign-in page after successful password update
    } catch (error) {
      setLoading(false);
      ...
      <div className="container">
        ...
        {step === 1 && (
          <form className="shadow" onSubmit={handleSendOTP}>
            ...
            <p>Enter your email to receive an OTP for password update.</p>
            <br />
            <input
              type="email"
        ...
        {step === 3 && (
          <form className="shadow" onSubmit={handleUpdatePassword}>
            <h2 className="color">Update Password</h2>
